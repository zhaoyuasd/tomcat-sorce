...
public class DataSourceLinkFactory extends ResourceLinkFactory {
     ...
     * so that when {@link DataSource#getConnection()} is called, it will invoke
     * {@link DataSource#getConnection(String, String)} with the preconfigured username and password.
     */
