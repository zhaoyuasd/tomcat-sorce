...
/**
 * <p>
 * An adapter for JDBC drivers that do not include an implementation of {@link ConnectionPoolDataSource}, but
 * still include a {@link DriverManager} implementation. <code>ConnectionPoolDataSource</code>s are not used
